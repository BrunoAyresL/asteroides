extern  cor, circle, tabela_cos, tabela_sen
global render_asteroide, spawn_asteroide, asteroides, reseta_asteroides
...
loop_reset:
        ...
        MOV     byte [SI + ast_vivo], 0         ; mata todos os asteroides
